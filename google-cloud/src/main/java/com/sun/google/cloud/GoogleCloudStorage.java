...
public class GoogleCloudStorage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GoogleCloudStorage googleCloudStorage =
            new GoogleCloudStorage("E:/TECH LEARNING/STS_Workspace-main/google-cloud/src/main/resources/google_auth.json", "famous-analyzer-347515");

        // Bucket require globally unique names, so you'll probably need to change this
        Bucket bucket = googleCloudStorage.getBucket("sahid-1-bucket");
        ...
        System.out.println("Read modified data: "+ value);
